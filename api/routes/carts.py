...
# Loading products from the products.json file
with open("./json/products.json") as f:
    products_db = json.load(f)

# Defining JSON file that stores cart data
# Assume the file name is "carts.json"
carts_db = {}

# End Point for adding a new product to the cart
...
# End Point for updating the quantity of a product in the cart
...
# End Point for deleting a product from the cart
...
# End Point for getting the aggregated cart information
